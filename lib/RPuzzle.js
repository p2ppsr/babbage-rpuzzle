const Signature = require('babbage-bsv').crypto.Signature;
const ECDSA = require('babbage-bsv').crypto.ECDSA;
const BN = require('babbage-bsv').crypto.BN;
const Opcode = require('babbage-bsv').Opcode;
const PrivateKey = require('babbage-bsv').PrivateKey;
const PublicKey = require('babbage-bsv').PublicKey;
const HDPrivateKey = require('babbage-bsv').HDPrivateKey;
const HDPublicKey = require('babbage-bsv').HDPrivateKey;
const Transaction = require('babbage-bsv').Transaction;
const Script = require('babbage-bsv').Script;
const Hash = require('babbage-bsv').crypto.Hash;
...
RPuzzle.fromPublicKey = (pub) => {
    ...
    const r = RValue.fromPublicKey(pub);
...
RPuzzle._isHDPublicKey = (xpub) => {
    const HDPublicKey = require('babbage-bsv').HDPublicKey;
...
/**
 * Add kValue to RPuzzle
 */
RPuzzle.KValue = KValue;

/**
 * Add RValue to RPuzzle
 */
RPuzzle.RValue = RValue;
